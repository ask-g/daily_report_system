...
<h2>id: ${employee.id}従業員情報詳細ページ</h2>
...
<p><a href="<c:url value='action=${actEmp}&command=${commEdit}&id=${employee.id}'/>">この従業員情報を編集する</a>
</p>

<p><a href="<c:url value='action=${actEmp}&command=${commIdx}'/>">一覧に戻る</a>
</p>
