...
<label for="${AttributeConst.EMP_PASS.getVlaue() }">パスワード</label><br/>
...
<option value="${AttributeConst.ROLE_ADMIN.getIntegerValue() }"<c:if test="{employee.adminFlag==AttributeConst.ROEL_ADMIN.getIntegerValue()}">selected</c:if>>管理者</option>
</select>
<br/><br/>
